 ...
 * @s: the string that needs to be changed
 ...
 * @estr: a string containing specific error type
 * Return: 0 if there are no numbers in string, 
 *        -1 if error
 */
...
/**
 * print_d - the function will print a decimal number
 * @input: the input
 * @fd: the file descriptor to note
 *
...
/**
 * remove_comments - this function substitutes first instance of '#' with '\0'
