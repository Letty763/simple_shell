...
/**
 * check_alias - this will scan for alias’
 * @arr: this will be the argument array
 * @alias: this will be the alias’ array
 * @idx: this will be the int used
...
/**
 * and_handling - responsible for the &&
 * @line: where command line is input
...
/**
 * semi_column_handling - responsible for semi-colon
 * @line: where command line is input
 * @name: the filename for the program
 * @alias: this will be the alias’ array
 * @idx: this will be the int used
...
/**
 * split_line - this will scan the input in the command line
 * @line: where command line is input
 * @name: the filename for the program
 * @alias: this will be the alias’ array
 * @idx: this will be the int used
